...
export default function Brands() {
    return ( <section className = 'lg:pt-16 lg:h-[200px] bg-white flex flex-col justify-center mt-12 text-center' >
    ...
    <motion.div variants = { fadeIn('up', 0.4) }
        ...
        <div className = 'grid grid-cols-3 gap-4 place-items-center lg:flex lg:flex-wrap lg:gap-x-6 lg:justify-between'>
        <div>
